...
"object" == typeof Countries && (Countries.updateProvinceLabel = function (e, t) {
  ...
  var _config = {
    ...
    if( t.length && r.length ) {
      ...
      var n = Handlebars.compile(jQuery.trim(t.text())), a = n(e);
      if( jQuery(a).appendTo(r), "undefined" != typeof Currency && "function" == typeof Currency.convertAll ) {
        var i = "";
        jQuery("[name=currencies]").size() ? i = jQuery("[name=currencies]").val() : jQuery("#currencies span.selected").size() && (i = jQuery("#currencies span.selected").attr("data-currency")), "" !== i && Currency.convertAll(shopCurrency, i, "#wrapper-response span.money")
      }
    }
    ...
    jQuery(".shipping-total-price").html('$0.00'), _enableButtons();
    ...
    if( t.zip && (r += t.zip + ", "), t.province && (r += t.province + ", "), r += t.country, e.length ) {
      "0.00" == e[0].price ? jQuery(".shipping-total-price").html("FREE") : jQuery(".shipping-total-price").html(_formatRate(e[0].price));
      for ( var n = 0; n < e.length; n++ ) e[n].price = _formatRate(e[n].price)
    }
    _render({rates: e, address: r, success: !0}), jQuery("#" + _config.wrapperId + "").fadeIn()
  ...
  return _init = function () {
    ...
    "undefined" != typeof Countries && (Countries.updateProvinceLabel(e.val(), t), e.change(function () {
      ...
      _disableButtons(), jQuery(".shipping-total-price").html('$0.00');
      var e = {};
